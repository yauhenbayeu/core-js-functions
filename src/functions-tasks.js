...
function getPowerFunction(exponent) {
  return function handlePowerFunction(number) {
...
function getPolynom(...coefficients) {
  ...
  return function handlePolynom(x) {
...
function logger(func, logFunc) {
  return function handleLogger(...args) {
    ...
    const logStart = `${funcName}(${stringArgs}) starts`;
    const logEnd = `${funcName}(${stringArgs}) ends`;
...
function partialUsingArguments(fn, ...initialArgs) {
  return function handler(...additionalArgs) {
